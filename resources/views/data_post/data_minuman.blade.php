...
<section class="statistic statistic2">
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <h3 class="title-5 m-b-35">Data Minuman</h3>
            </div>
            <div class="col-md-6">
                <p class=" m-b-35" style="text-align:right;">
                    <a href="{{url('buat_resep/minuman')}}" class="btn" style="background-color:#e44d26;color:white;">
                    Buat Resep</a>
                </p>
            </div>
        </div>
        @if($minumanku->count('id_post')=='0')
...
<div class="modal fade" id="deleteModal"  role="dialog" aria-labelledby="deleteModalLabel" aria-hidden="true" data-backdrop="static">
    <div class="modal-dialog modal-sm" role="document">
        ...
        <form action="{{route('minuman_delete')}}" method="POST">
               {{ method_field('delete') }}
               {{ csrf_field() }}
            <div class="modal-header">
                <h5 class="modal-title text-center" id="editModalLabel">Hapus Minuman</h5>
