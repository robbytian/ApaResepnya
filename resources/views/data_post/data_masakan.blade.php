...
<section class="statistic statistic2">
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <h3 class="title-5 m-b-35">Data Masakan</h3>
            </div>
            <div class="col-md-6">
                <p class=" m-b-35" style="text-align:right;">
                    <a href="{{url('buat_resep/masakan')}}" class="btn" style="background-color:#e44d26;color:white;">
                    Buat Resep</a>
                </p>
            </div>
        </div>
        @if($masakanku->count('id_post')=='0')
