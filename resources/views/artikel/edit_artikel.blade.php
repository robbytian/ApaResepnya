                    ...
                    <div class="card-body">
                        ...
                        {{ method_field('patch') }} 
                            <div class="row form-group">
                                ...
                                <div class="col-sm-9">
                                    <input  type="text" class="form-control" name="judul" placeholder="Judul" value="{{@$data_artikel->judul}}">
                                </div>
                            </div>
                            <div class="row form-group">
                                <div class="col-sm-3">
                                ...
                                <div class="col-sm-9">
                                    <div class="rs-select2--dark rs-select2--lg m-r-10 rs-select2--border">
                                        <select name="sub_artikel" id="select" class="form-control select2">
                                           ...
                                           @foreach($sub_artikel as $row)
                                           <option value="{{$row->id_sub_artikel}}"  {{$data_artikel->id_sub_artikel == $row->id_sub_artikel ? 'selected' : ''}}>{{$row->nama}}</option>
                                           @endforeach
                                       </select>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-sm-9">
                                    <div class="au-form-icon">
                                        <input class=" form-control au-input au-input--full" type="text" id="cover-link" name="cover-link" class="form-control" placeholder="https://" {{strpos(substr(strstr($data_artikel->thumbnail,'assets'), 1),'/images/thumbnail') ? "" : "value=$data_artikel->thumbnail"}}>
                                        <div style="display:none">
                                            ...
                                            <img id="foto" src="{{strpos(substr(strstr($data_artikel->thumbnail,'assets'), 1),'/images/thumbnail') ? asset($data_artikel->thumbnail) : ''}}" class="imgResep" display="none" />
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-sm-9">
                                    <textarea class="form-control" id="editor1" name="isiText" placeholder="Enter text ...">{{@$data_artikel->isi_artikel}}</textarea>
                                </div>
                            </div>
                        </form>
                    </div>
