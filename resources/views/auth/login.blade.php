        ...
        @include('template.feedback')   
            ...
            <div class="login-form">
                ...
                <div>
                    ...
                    <a type="button" class="btn btn-default btn-block btn-facebook text-white">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-5">
                            <label class="text-right font-10">
                                <a href="{{url('forgotpassword')}}">Lupa Password?</a>
                            </label>
                        </div>
                    </div>
                    <button class="btn btn-block btn-orange" type="submit">Login</button>
                </form>
