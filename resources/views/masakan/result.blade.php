...
<section class="statistic statistic2">
    <div class="container">
        <div class="row">
            <div class="col-xl-2">
                @include('template.sub_makanan')
            </div>
            <div class="col-xl-8  scroll-post">
                <div class="page-content">
                    @if($masakan_filter->count('id_post') == '0')
                        <h1 class="text-center text-middle">Data Resep Tidak Ada</h1>
                    @endif
                    <div class="row">                        
                        @foreach($masakan_filter as $row)
                            @php 
